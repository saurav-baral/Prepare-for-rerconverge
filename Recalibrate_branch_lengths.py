...
tree_folders = ["tree_1", "tree_10", "tree_2", "tree_3", "tree_4", "tree_5", "tree_6", "tree_7", "tree_8", "tree_9"]
def run_rscript(folder_name):
    ...
    # result = subprocess.run(f'cd "/mnt/c/Users/sauba/Desktop/Drosophila_BUSCO_ERC/14.Add even more species/0.Code/"\n"/mnt/c/Program Files/R/R-4.4.2/bin/Rscript.exe" Tree_recalibrate.R {folder_name}', 
    #                     shell=True, 
    #                     capture_output=True,  # capture stdout/stderr
    #                     text=True)
    # subprocess.run(f'cd "/mnt/c/Users/sauba/Desktop/Drosophila_BUSCO_ERC/14.Add even more species/0.Code/"\n"/mnt/c/Program Files/R/R-4.4.2/bin/Rscript.exe" Tree_recalibrate.R {folder_name}', shell=True)     
    print(f'cd "/mnt/c/Users/sauba/Desktop/Drosophila_BUSCO_ERC/14.Add even more species/0.Code/"\n"/mnt/c/Program Files/R/R-4.4.2/bin/Rscript.exe" Tree_recalibrate.R {folder_name}')
